...
//        viewPager.translatesAutoresizingMaskIntoConstraints = false
        ...
        let segmentedControl = BMSegmentedControl.init(
            ...
            items: ["Happy", "Normal"],
            icons: [UIImage(named: "IconPersonal.png", in: Bundle.module, compatibleWithTraitCollection: nil)!,
                    UIImage(named: "IconNews.png", in: Bundle.module, compatibleWithTraitCollection: nil)!],
            selectedIcons: [UIImage(named: "IconPersonal.png", in: Bundle.module, compatibleWithTraitCollection: nil)!,
                            UIImage(named: "IconNews.png", in: Bundle.module, compatibleWithTraitCollection: nil)!],
